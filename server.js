...
// Helper: normalise playerID to lowercase for storage/comparison
...
app.post('/startGame', (req, res) => {
  ...
  // Normalise every player in the provided list
...
app.get('/getPlayers', (req, res) => {
  ...
  // Returns the stored lowercase IDs
...
app.post('/updateGameState', (req, res) => {
  ...
  // Case‑insensitive current player check
